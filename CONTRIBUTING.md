...
`desktop/` is an Electron app that runs the release stack (`desktop/docker-compose.yml`) behind a window. To work on it
against your dev stack, with Docker left alone:
