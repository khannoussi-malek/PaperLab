...
- Only when the question asks you to write notes, write each note as its own block: a line ":::note", the note with its citations, then a line ":::". One idea per note, kept short. Otherwise never write these blocks.
